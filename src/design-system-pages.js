...
function createDesignSystemPages({ shellContent, section }) {
  ...
  const colors = shellContent({
    ...
    description: 'O lime original identifica a CIIMO. No tema Light, a interface usa #AFC728 como accent principal para ganhar contraste sobre superfícies claras, enquanto um verde mais escuro preserva legibilidade quando a cor carrega conteúdo.',
    index: ['01 — Accent', '02 — Neutros', '03 — Semânticos', '04 — Regra'],
    sections: [
      section('01', 'Accent', 'A cor principal muda com o tema', 'Dark preserva o lime original #D4FB00. Light usa #AFC728 para CTA, seleção preenchida, gráficos e destaques principais. Texto e ícones verdes no Light continuam usando #5B6C00.', `<div class="brand-color-board"><div style="--swatch:#D4FB00"><span></span><strong>accent / Dark</strong><code>#D4FB00</code><small>Accent principal no Dark · identidade</small></div><div style="--swatch:#AFC728"><span></span><strong>accent / Light</strong><code>#AFC728</code><small>CTA · seleção · gráfico · destaque</small></div><div style="--swatch:#5B6C00"><span></span><strong>accent-content / Light</strong><code>#5B6C00</code><small>Texto · ícone · foco</small></div></div>`),
      ...
      section('04', 'Regra', 'Accent preenchido ≠ cor de conteúdo', 'No Light, #AFC728 é a cor principal da interface, mas não deve ser usada como texto fino sobre branco. Texto, ícone, foco e indicadores verdes usam #5B6C00. Os SVGs oficiais permanecem intactos.', `<div class="alert success">Dark: #D4FB00. Light: #AFC728. Conteúdo verde no Light: #5B6C00.</div>`),
    ],
  });
  ...
  const primitiveTokens = shellContent({
    ...
    sections: [
      section('01', 'Color', 'Valores-base', 'Não use o nome do papel aqui. Primitive descreve o valor.', `<div class="data-list"><div class="list-row"><strong>lime-500</strong><small>#D4FB00</small><small>Color</small><small>Primitive</small></div><div class="list-row"><strong>olive-lime-500</strong><small>#AFC728</small><small>Color</small><small>Primitive</small></div><div class="list-row"><strong>olive-700</strong><small>#5B6C00</small><small>Color</small><small>Primitive</small></div><div class="list-row"><strong>black-1000</strong><small>#000000</small><small>Color</small><small>Primitive</small></div><div class="list-row"><strong>ivory-100</strong><small>#F4F1EA</small><small>Color</small><small>Primitive</small></div></div>`),
  ...
  const semanticTokens = shellContent({
    ...
    sections: [
      ...
      section('03', 'Accent', 'Accent de interface e conteúdo separados', 'O accent principal muda por tema; conteúdo verde continua usando um papel próprio para manter leitura.', `<div class="data-list"><div class="list-row"><strong>color.theme.accent</strong><small>--accent</small><small>Dark #D4FB00 / Light #AFC728</small><small>CTA · seleção · gráficos</small></div><div class="list-row"><strong>color.content.accent</strong><small>--accent-content</small><small>Dark #D4FB00 / Light #5B6C00</small><small>Texto · ícone · foco</small></div></div>`),
