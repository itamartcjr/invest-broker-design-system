...
const home = shellContent({
  ...
  sections: [
    ...
    section('04', 'Publicação', 'Site estático gerado com Node', 'O conteúdo é compilado para dist e publicado no GitHub Pages por GitHub Actions, sem framework de runtime.', `<div class="specimen"><div class="specimen-label"><span>Build</span><code>npm run build</code></div><div class="cluster"><span class="chip active">Node 20</span><span class="chip">Static HTML</span><span class="chip">GitHub Actions</span><span class="chip">GitHub Pages</span></div></div>`),
  ],
});
...
const coverage = shellContent({
  ...
  sections: [
    section('01', 'Fundamentos', 'Base visual e de comportamento', 'Cor, tipografia, spacing, radius, grid, motion, acessibilidade e comportamento responsivo.', `<div class="cluster"><span class="chip">Color</span><span class="chip">Typography</span><span class="chip">Spacing</span><span class="chip">Radius</span><span class="chip">Grid</span><span class="chip">Motion</span><span class="chip">A11y</span></div>`),
