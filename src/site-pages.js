...
const coverage = shellContent({
  ...
  sections: [
    section('01', 'Fundamentos', 'Base visual e de comportamento', 'Cor, tipografia, spacing, radius, grid, motion, acessibilidade e comportamento responsivo seguem os tokens já documentados no CIIMO.', `<div class="cluster"><span class="chip">Color</span><span class="chip">Typography</span><span class="chip">Spacing</span><span class="chip">Radius</span><span class="chip">Grid</span><span class="chip">Motion</span><span class="chip">A11y</span></div><div class="grid grid-3" style="margin-top:24px"><div class="metric"><small>Spacing</small><strong>6 · 10 · 16 · 24 · 32</strong></div><div class="metric"><small>Sidebar desktop</small><strong>82 / 248 px</strong></div><div class="metric"><small>Page shell</small><strong>0 px · seção 24 px</strong></div></div><p style="margin-top:16px">No desktop, o cabeçalho usa 32 px como espaço macro e cada seção interna usa 24 px, o token de seção do CIIMO. No mobile, cabeçalho e seções usam 24 px no eixo vertical e 16 px no horizontal. O shell da página permanece sem padding próprio.</p>`),
